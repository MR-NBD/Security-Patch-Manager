...
Successivamente, il lavoro è stato contestualizzato anche nell’ambito PSN, ipotizzando una definizione che potesse allinearsi alle specifiche esigenze contrattuali. In tale contesto, il patch management viene definito come segue: “Security Patch Management for PSN consists in achieving comprehensive visibility into the health of all managed assets through a centralized system that enables automated identification, acquisition, testing, installation, and verification of third-party security patches, without compromising the operational stability of clients’ production environments.”
